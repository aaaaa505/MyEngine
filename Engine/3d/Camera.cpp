...
void Camera::MoveCamera(Input* input, const float movePower)
{
	assert(input);
	...
	{
		const XMFLOAT3 powerL = { -movePower,  0.0f,       0.0f };
		const XMFLOAT3 powerR = {  movePower,  0.0f,       0.0f };
		const XMFLOAT3 powerU = {  0.0f,       movePower,  0.0f };
		const XMFLOAT3 powerD = {  0.0f,      -movePower,  0.0f };
		const XMFLOAT3 powerF = {  0.0f,       0.0f,       movePower };
		const XMFLOAT3 powerB = {  0.0f,       0.0f,      -movePower };
